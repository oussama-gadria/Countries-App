...
const CountriesList = () => {
  ...
  return (
    <div className="bg-veryLightGray dark:bg-veryDarkBlue ">
      ...
      <div className="flex md:flex-row flex-col mx-3 justify-between pt-10 pb-8 pr-7 ">
        <form>
          <div className="relative mx-7 ">
            ...
            <input
              type="search"
              id="default-search"
              className="h-[42px] w-[400px] pl-14 text-gray-900 text-xs rounded-lg bg-gray-50   dark:border-darkBlue dark:placeholder-gray-400 dark:text-white   dark:bg-darkBlue"
